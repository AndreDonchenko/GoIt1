...
<table class="table table-striped">
    <tr>
        <th>Employee &nbsp <input type="search" name="filterEmployee" id="filterEmployee" placeholder="Поиск"
                                  onchange="applyFilter()"></th>
        <th>Date &nbsp <input type="date" name="filterDate" id="filterDate" placeholder="Поиск"
                              onchange="applyFilter()"></th>
        <th>Table &nbsp <input type="number" name="filterTable" id="filterTable" placeholder="Поиск"
                               onchange="applyFilter()"></th>
        <th>Open</th>
        <th>Action</th>
    </tr>
    <c:forEach var="order" items="${ordersList}">
        <tr>
            ...
            <td>${order.open}</td>
            <td>
                <button class="btn btn-primary" onclick="location.href='/admin/orders/editDetail/${order.id}'">Edit
                </button>
